// FIPS state code -> { name, abbr } for the 50 states + DC.
// Matches the ids used in the us-atlas "states-10m" topology.
const STATE_FIPS = {
...
// Edit this list to change which states show as visited by default
// (only used the very first time the page loads, before anything is saved).
